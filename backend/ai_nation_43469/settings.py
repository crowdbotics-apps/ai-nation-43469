"""
Django settings for ai_nation_43469 project.
...
ROOT_URLCONF = 'ai_nation_43469.urls'
...
WSGI_APPLICATION = 'ai_nation_43469.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ai_nation_43469 API",
    "DESCRIPTION": "API documentation for ai_nation_43469 App",
    "VERSION": "v1",
}
